	...
	public class SaveLoad
	{
				...
				switch (reader.NodeType)
				{
					case XmlNodeType.Element:
						...
						switch (reader.Name)
						{
							...
							case "meeting":
								currentMeeting = currentGroup.AddMeeting(reader.GetAttribute("name"), "", currentGroup.Users);
								break;

							case "post":
								currentPost = currentMeeting.AddPost(reader.GetAttribute("name"), "", currentGroup.Users);
		...
		static protected string FormatXMLText(string text, string mode)
		{
			...
			if (mode == "load")
				...
				text = text.Replace("\t", "").Replace("\b", "").Replace(Environment.NewLine, "\n");
